        ...
        return (
            <div className='flex'>
                ...
                <div className="tournamentBox flex" style={TournamentHistoryStyles.TournamentBox}>
                    ...
                    <div className="tournName" style={TournamentHistoryStyles.TournamentDecoration}>{this.state.tournName}</div>
                    <div className="tournCreator" style={TournamentHistoryStyles.TournamentDecoration}>{this.state.tournCreator}</div>
                    <div className="playerBox flex">
                        <div className="firstPlayerName" style={TournamentHistoryStyles.TournamentDecoration}>{this.state.firstPlayerName}</div>
                    ...
                    <div className="playerBox flex">
                        <div className="secondPlayerName" style={TournamentHistoryStyles.TournamentDecoration}>{this.state.secondPlayerName}</div>
                        <div className="secondPlayerImg" style={TournamentHistoryStyles.PlayerImg}/>
                    </div>
                    <div className="tournDate" style={TournamentHistoryStyles.TournamentDecoration}>{this.state.tournDate}</div>
                    <div className="tournScore" style={TournamentHistoryStyles.TournamentDecoration}>{this.state.tournScore}</div>
                </div>
                    <div className="tournamentBox flex" style={TournamentHistoryStyles.TournamentBox}>
                        <div className="tournImg" style={TournamentHistoryStyles.LogoTourn}/>
                        <div className="tournName" style={TournamentHistoryStyles.TournamentDecoration}>{this.state.tournName}</div>
